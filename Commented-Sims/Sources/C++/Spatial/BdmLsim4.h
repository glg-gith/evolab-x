...
class BdmLsim4 : public LabSimulatorTime, public LabNetBinding {
public:
...
//	static double GetAttrValue(t_site *a_site, int t_site_attr);
//	static void SetAttrValue(t_site *a_site, int t_site_attr, double value);
