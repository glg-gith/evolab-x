...
void validatecl()
{
	...
	if (w0 < 0.01 || w0 > 100.0f) 				{fprintf(stderr, "'w0' must be between 0.01 and 100.0");exit(0);}
	...
	if (tmax < 0.0f || tmax > 100000000.0f) 	{fprintf(stderr, "'tmax' must be between 0.0 and 100000000.0");exit(0);}
