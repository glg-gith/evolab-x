...
class Percolation_Sim: public Simulator
{
    ...
    public:
        ...
        Percolation_Sim(LabNetwork* net):Simulator(net) {};
        ~Percolation_Sim() { };
        ...
        vector<LabNode*> rand_infect (int n) {
            assert(n > 0);
            vector<LabNode*> patients_zero = rand_set_nodes_to_state(n, I);
            for (int i = 0; i < n; i++) {
