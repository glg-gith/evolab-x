...
struct qt_meta_stringdata_LifeCycleListItem_t {
    QByteArrayData data[1];
    char stringdata0[18];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_LifeCycleListItem_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_LifeCycleListItem_t qt_meta_stringdata_LifeCycleListItem = {
    {
QT_MOC_LITERAL(0, 0, 17) // "LifeCycleListItem"
...
const QMetaObject LifeCycleListItem::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_LifeCycleListItem.data,
      qt_meta_data_LifeCycleListItem,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *LifeCycleListItem::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_LifeCycleListItem.stringdata0))
