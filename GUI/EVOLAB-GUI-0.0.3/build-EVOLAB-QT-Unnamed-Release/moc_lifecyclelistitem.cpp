...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_LifeCycleListItem_t, stringdata) + ofs \
...
const QMetaObject LifeCycleListItem::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_LifeCycleListItem.data,
      qt_meta_data_LifeCycleListItem,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_LifeCycleListItem.stringdata))
