...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_MouseAndKeyPressOnlyFilter_t, stringdata) + ofs \
...
const QMetaObject MouseAndKeyPressOnlyFilter::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_MouseAndKeyPressOnlyFilter.data,
      qt_meta_data_MouseAndKeyPressOnlyFilter,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_MouseAndKeyPressOnlyFilter.stringdata))
