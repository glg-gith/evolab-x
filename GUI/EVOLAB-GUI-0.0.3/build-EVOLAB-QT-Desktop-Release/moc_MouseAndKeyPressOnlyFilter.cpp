...
static const char qt_meta_stringdata_MouseAndKeyPressOnlyFilter[] = {
    "MouseAndKeyPressOnlyFilter\0"
};
...
const QMetaObjectExtraData MouseAndKeyPressOnlyFilter::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject MouseAndKeyPressOnlyFilter::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_MouseAndKeyPressOnlyFilter,
      qt_meta_data_MouseAndKeyPressOnlyFilter, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &MouseAndKeyPressOnlyFilter::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_MouseAndKeyPressOnlyFilter))
